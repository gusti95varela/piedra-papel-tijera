...
btn_piedra.onclick = function(){
    Opcion_jugador = 0;
    img_usuario.src = "bootstrap/img/Piedra.png";
}

btn_papel.onclick = function(){
    Opcion_jugador = 1;
    img_usuario.src = "bootstrap/img/Papel.png";
}

btn_tijeras.onclick = function(){
    Opcion_jugador = 2;
    img_usuario.src = "bootstrap/img/Tijeras.png";
}
...
function init_imagenes(){
    btn_piedra.style.backgroundImage = "url('bootstrap/img/Piedra.png')";
    btn_papel.style.backgroundImage = "url('bootstrap/img/Papel.png')";
    btn_tijeras.style.backgroundImage = "url('bootstrap/img/Tijeras.png')";
...
function display_opcion_cpu(opcion){
    if (opcion === 0) {
        img_cpu.src = "bootstrap/img/Piedra.png";
    } else if (opcion === 1) {
        img_cpu.src = "bootstrap/img/Papel.png";
    } else {
        img_cpu.src = "bootstrap/img/Tijeras.png";
    }
}